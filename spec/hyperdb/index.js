...
// '@key-collection/key-entries' collection key
...
// '@key-collection/key-entries' value encoding
const collection0_enc = getEncoding('@key-collection/key-entry/hyperdb#0')

// '@key-collection/key-entries' reconstruction function
...
// '@key-collection/key-entries' key reconstruction function
...
const collection0 = {
  name: '@key-collection/key-entries',
  id: 0,
  encodeKey (record) {
...
function resolveCollection (name) {
  switch (name) {
    case '@key-collection/key-entries': return collection0
    default: return null
  }
}
